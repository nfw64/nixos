...
ShellRoot {
    ...
    readonly property color crust: ts.bgSurfaceDef
    readonly property color text: ts.textPrimary
    readonly property color subtext0: ts.textSecondary
    readonly property color surface0: ts.bgHover
    readonly property color surface1: ts.bgSelected
    readonly property color surface2: ts.bgHighest
    readonly property color overlay2: ts.bgSurfaceInv

    readonly property color mauve: ts.accentPrimary
    readonly property color green: ts.accentGreen
    readonly property color red: ts.accentRed
    readonly property color peach: ts.accentCyan
    readonly property color blue: ts.accentPrimary
    ...
    WlSessionLock {
        ...
        WlSessionLockSurface {
            ...
            Item {
                ...
                Process {
                    id: userPoller
                    command: ["bash", "-c", "USER_VAR=$(whoami); ICON_PATH=\"\"; if [ -f ~/.face.icon ]; then ICON_PATH=$(readlink -f ~/.face.icon); elif [ -f ~/.face ]; then ICON_PATH=$(readlink -f ~/.face); elif [ -f ~/nixos/assets/face.ico ]; then ICON_PATH=$(readlink -f ~/nixos/assets/face.ico); fi; echo -n \"$USER_VAR|$ICON_PATH\""]
                    stdout: StdioCollector {
                        onStreamFinished: {
                ...
                Process {
                    id: kbPoller
                    command: ["bash", "-c", "niri msg -j keyboard-layouts | jq -r '.names[]' | head -n1 | cut -c1-2 |  tr '[:lower:]' '[:upper:]'"]
                ...
                Item {
                    ...
                    opacity: screenRoot.introState
                    transform: Translate {
                        y: (30 * screenRoot.sc) * (1.0 - screenRoot.introState)
                    }
                        ...
                        ColumnLayout {
                            ...
                            RowLayout {
                                ...
                                Rectangle {
                                    ...
                                    color: lockUI.failed ? Qt.rgba(root.red.r, root.red.g, root.red.b, 0.2) : (lockUI.authenticating ? Qt.rgba(root.peach.r, root.peach.g, root.peach.b, 0.2) : Qt.rgba(root.mauve.r, root.mauve.g, root.mauve.b, 0.15))
                ...
                RowLayout {
                    ...
                    opacity: screenRoot.introState
                    transform: Translate {
                        y: (20 * screenRoot.sc) * (1.0 - screenRoot.introState)
                    }
                ...
                Rectangle {
                    ...
                    ColumnLayout {
                        ...
                        Rectangle {
                            ...
                            Layout.rightMargin: 10 * screenRoot.sc
                            radius: 12 * screenRoot.sc
                            color: ma4.containsMouse ? Qt.rgba(root.mauve.r, root.mauve.g, root.mauve.b, 0.1) : "transparent"
                            scale: ma4.pressed ? 0.95 : (ma2.containsMouse ? 1.02 : 1.0)
                            Behavior on color {
                                ColorAnimation {
                                    duration: 200
                                }
                            ...
                            RowLayout {
                                ...
                                Text {
                                    ...
                                    font.family: "Iosevka Nerd Font"
                                    font.pixelSize: 18 * screenRoot.sc
                                    color: ma4.containsMouse ? root.mauve : Qt.rgba(root.mauve.r, root.mauve.g, root.mauve.b, 0.6)
                                    Behavior on color {
                                        ColorAnimation {
                                            duration: 200
                                        }
