...
Scope {
    ...
    function launchApp(entry) {
        entry.execute();
        launcherPanel.isPanelOpen = false;
    }
    ...
    PanelWindow {
        ...
        WlrLayershell.keyboardFocus: isPanelOpen ? WlrKeyboardFocus.Exclusive : WlrKeyboardFocus.None
        WlrLayershell.namespace: "quickshell-launcher"

        exclusionMode: ExclusionMode.Ignore
        visible: isPanelOpen || rootContainer.opacity > 0
        ...
        // Animation shit, idk if this is efficient
        Rectangle {
            id: rootContainer
            anchors.fill: parent
            color: "transparent"
            opacity: launcherPanel.isPanelOpen ? 1.0 : 0.0
            visible: opacity > 0
