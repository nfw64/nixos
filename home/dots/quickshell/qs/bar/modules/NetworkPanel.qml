...
PopupWindow {
    ...
    visible: isOpen || closeAnimation.running

    // Force focus down into your FocusScope when opened
    onIsOpenChanged: {
        if (isOpen) {
            popupPanel.forceActiveFocus();
        }
    }
                ...
                transitions: [
                    Transition {
                        ...
                        NumberAnimation {
                            properties: "height"
                            duration: 220
                            easing.type: Easing.OutCubic // Snappy start, smooth finish
                        }
                    },
                    Transition {
                        id: closeAnimation
                        ...
                        NumberAnimation {
                            properties: "height"
                            duration: 180
                            easing.type: Easing.InCubic // Clean acceleration upward
                        }
                    }
                ]
