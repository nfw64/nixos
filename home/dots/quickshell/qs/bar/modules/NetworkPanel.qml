...
PopupWindow {
  ...
  visible: isPanelOpen || slideWrapper.opacity > 0
  ...
  FocusScope {
    ...
    MouseArea {
      ...
      // If mouse coordinates drop outside your inner layout box dimensions, close it
      onClicked: {
        isPanelOpen = false;
      }
    }
    ...
    implicitWidth: 340
    implicitHeight: contentColumn.childrenRect.height + 29
