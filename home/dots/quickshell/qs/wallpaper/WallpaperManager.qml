...
Scope {
    ...
    property bool isWallpaper: false

    IpcHandler {
        target: "wallpaper"

        function toggle(): void {
            root.isWallpaper = !isWallpaper;
    ...
    PanelWindow {
        id: wallpaperPanel
        visible: root.isWallpaper || rootContainer.opacity > 0
        focusable: true
        color: "transparent"

        WlrLayershell.layer: WlrLayer.Overlay
        WlrLayershell.keyboardFocus: isWallpaper ? WlrKeyboardFocus.Exclusive : WlrKeyboardFocus.None
        ...
        Rectangle {
            ...
            anchors.fill: parent
            color: "transparent"
            opacity: root.isWallpaper ? 1.0 : 0.0
            visible: opacity > 0
            ...
            Rectangle {
                ...
                ColumnLayout {
                    ...
                    PersistentProperties {
                        id: wallCache
                        reloadableId: "system_wallpaper_list_cache"

                        property string dynamicImagePaths: "[]"
                    }

                    FolderListModel {
                        id: wallpaperScanner
                        folder: "file:///home/myriad/nixos/assets/wallpapers/"
                        ...
                        onCountChanged: {
                            ...
                            for (let i = 0; i < count; i++) {
                                filesList.push(wallpaperScanner.get(i, "filePath"));
                            }
                            wallCache.dynamicImagePaths = JSON.stringify(filesList);
                        }
                    }
                    ...
                    GridView {
                        ...
                        model: JSON.parse(wallCache.dynamicImagePaths)
