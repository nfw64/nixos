...
QtObject {
    ...
    readonly property color bgSurfaceDef: "{{colors.surface.default.hex}}"
    readonly property color bgSurfaceInv: "{{colors.inverse_surface.default.hex}}"
    ...
    readonly property color bgHighest: "{{colors.surface_container_highest.default.hex}}"
